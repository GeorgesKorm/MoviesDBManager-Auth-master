    ...
    public class AccountsController : Controller
    {
        ...
        public ActionResult Login(LoginCredential loginCredential)
        {
            if (ModelState.IsValid)
            {
                ...
                if (OnlineUsers.IsOnline(user.Id)) //Georges made this. Le point 3
                {
                    return RedirectToAction("Index", "Movies");
                }
                OnlineUsers.AddSessionUser(user.Id);
                OnlineUsers.ConnectedUsersId.Add(user.Id); //Georges made this. Le point 2.
                return RedirectToAction("Index", "Movies");
            }
        ...
        public ActionResult Logout()
        {
            ...
            if (loggedUser != null)
            {
                OnlineUsers.ConnectedUsersId.Remove(loggedUser.Id); //Georges made this. Le point 2
                OnlineUsers.RemoveSessionUser();
            }
            return RedirectToAction("Login");
        }
        ...
        public ActionResult Users(bool forceRefresh = false)
        {
            ...
            {
                return PartialView(DB.Users.ToList().OrderBy(c => c.FirstName));
            }
            return null;
        }
